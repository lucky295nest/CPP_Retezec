...
int main() {
    Retezec niggerText("fucking");
    niggerText.GetLength();
    niggerText.GetString();

    Retezec otherText(" nigger");
    niggerText += otherText;
    niggerText.GetLength();
    niggerText.GetString();

    Retezec combinedText = niggerText + otherText;
    combinedText.GetLength();
    combinedText.GetString();

    char character = niggerText[4];
